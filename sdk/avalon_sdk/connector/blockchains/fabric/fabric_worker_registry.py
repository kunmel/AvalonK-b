...
class FabricWorkerRegistryImpl(WorkerRegistry):
    ...
    def worker_retrieve(self, worker_id, id=None):
        ...
        """
        if (self.__fabric_wrapper is not None):
            logging.info("self.__fabric_wrapper is not None")
            params = []
            ...
            workerDetails = self.__fabric_wrapper.invoke_chaincode(
                ...
                'workerRetrieve',
                params)
            logging.info("in registry , ready to return workerdetails")
            logging.info("the workerDetails is:")
            logging.info(workerDetails)
