...
class FabricWrapper():
    ...
    def invoke_chaincode(self, chaincode_name, method_name, params):
        ...
        """
        logging.info("in invoke_chaincode")
        ...
        if the_call['isQuery'] is True:
            logging.info("in if the_call['isQuery'] is True")
            if resp:
                result = []
                ...
                logging.info("ready return none")
                return None
        elif len(resp) > 0:
            ...
            if hasattr(resp[0], "status") and \
                ...
                logging.info("ready return ContractResponse.SUCCESS")
                return ContractResponse.SUCCESS
            else:
                logging.info("ready return ContractResponse.ERROR1")
                return ContractResponse.ERROR

        else:
            logging.info("ready return ContractResponse.ERROR2")
            return ContractResponse.ERROR
